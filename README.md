...
## Descripción
El script descarga datos abiertos de víctimas de la Fiscalía General de Justicia de la Ciudad de México (FGJ - CDMX) correspondientes al año 2024. Posteriormente, realiza un filtrado espacial para mapear interactivamente el delito de "ROBO A CASA HABITACION SIN VIOLENCIA" utilizando la librería `leaflet`.
